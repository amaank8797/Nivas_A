...
export default function HotelManagerSidebar({ open, onClose }) {
  const items = [
    { to: "/hotelmanager", label: "Manage Hotel", exact: true },
    { to: "/hotelmanager/manage-room", label: "Manage Room" },
    { to: "/hotelmanager/view-bookings", label: "View Bookings" },
  ];
